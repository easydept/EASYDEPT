...
const Inicio = () => {
  ...
  return (
    <div className="bg-white relative lg:py-6">
      <div
        className="shadow-[0_35px_60px_-15px_rgba(0,0,0,0.4)] bg-opacity-95 bg-custom-green rounded-xl flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row"
      >
          ...
          <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
            ...
            >
              ...
              <div className="w-full mt-6 space-y-11">
                ...
                <p className="text-sm mt-4 text-custom-green">
